...
def ConfirmParams(request):
    ...
    return JsonResponse({'message': "method not allowed", "success": 0}, status=200)
...
def upload_video(request):
    ...
    print(video_url)
    return render(request, 'uploadvideo.html', {'video_url': video_url})
...
def upload_photo(request):
    ...
    return render(request, 'uoloadphoto.html', {'video_url': photo_url})
