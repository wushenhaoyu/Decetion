...
from deploy12.python.infer import Predictor
...
class PaddleSegCamera:
    def __init__(self, cfg_file=None):
        ...
        if cfg_file:
            ...
            self.args.cfg = os.path.join(current_directory,"my_detection", 'output_inference', 'pp_liteseg_infer_model', 'deploy.yaml')
